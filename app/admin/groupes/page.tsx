        ...
        <div className="row justify-content-center">
            <div className="col-md-6">
                <div className="card shadow-sm p-4">
                    ...
                    <p className="text-muted text-center mb-4">Choisissez la session pour gérer les <strong>groupes</strong>.</p>
                    <div className="mb-4">
                        <SelectSession code="A26" onChange={(code: any) => setSession(code)} />
                    </div>
                    <button className="btn btn-primary btn-lg w-100" onClick={() => router.push(`groupes/${session}`)}>Accéder aux groupes</button>
                </div>
            </div>
        </div>
    </div>
